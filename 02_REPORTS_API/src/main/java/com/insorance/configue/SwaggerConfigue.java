package com.insorance.configue;
...
public class SwaggerConfigue {
    ...
    ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                .title("REPORT API Application for Insurance Module")
                .description("This Api is Build to Satisfy the Requirement of Insurance Report Application")
                .version("Version - 1.0")
