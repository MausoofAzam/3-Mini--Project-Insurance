package com.insourance.configue;
...
public class SwaggerConfigue {
    ...
    ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                .title("User Management (Login and SIgnUp functionality) Application for Insurance Module")
                .description("This Api is Build to Satisfy the Requirement of Insurance User Management Application")
                .version("Version - 1.0")
